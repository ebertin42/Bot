...
The bot for PlaceNL and their allies! This bot connects with the [command server](https://github.com/PlaceNL/Commando) and gets it's orders from there. You can see the orderhistory [here](https://place.bilaboz.me/).
...
2. Click on this link: [https://github.com/Bilaboz/Bot/raw/master/placenlbot.user.js](https://github.com/Bilaboz/Bot/raw/master/placenlbot.user.js). If everything went well you'll see Tampermonkey ask you to add it. Click **Install**.
